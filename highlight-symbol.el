...
(defcustom highlight-symbol-colors
  '("yellow" "DeepPink" "cyan" "MediumPurple1" "SpringGreen1"
    "DarkOrange" "HotPink1" "RoyalBlue1" "PeachPuff" "DodgerBlue" "brown" "DarkOrchid" "DarkTurquoise" "LawnGreen" "seashell4" "honeydew1" "LightGreen")
...
;;; highlight-symbol.el ends heres
